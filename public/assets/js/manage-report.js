...
$(function () {
    ...
    e.length && (a = e.DataTable({
        ajax: {
            url: "../assets/json/invoice-list.json",
            type: 'GET', // Ensure the method is set correctly (GET or POST)
            dataSrc: function (json) {
                console.log(json); // Log the response for debugging
                return json.data; // Make sure to return the correct data array
            }
        },
        columns: [{
            data: "invoice_id"
        ...
        columnDefs: [{
            ...
            render: function (a, e, t, s) {
                // console.log(t)
                return '<a href="/incident-reports/1">#' + t.invoice_id + "</a>"
            }
        }, {
            targets: 3,
            render: function (a, e, t, s) {
            ...
            orderable: !1,
            render: function (a, e, t, s) {
                return '<div class="d-flex align-items-center"><a href="/incident-reports/1" data-bs-toggle="tooltip" class="btn btn-icon" data-bs-placement="top" title="Preview Invoice"><i class="bx bx-show bx-md"></i></a></div></div>'
            }
        }],
        order: [[2, "desc"]],
        ...
        buttons: [{
            ...
            action: function (a, e, t, s) {
                window.location = "/incident-reports/create"
            }
        }],
        responsive: {
            details: {
