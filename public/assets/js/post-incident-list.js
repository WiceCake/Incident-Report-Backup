...
reloadTable = table.DataTable({
    ajax: '/api/v1/post_incident/reports',
    columns: [
        { data: 'post_incident_id' },        // Column 0
    ...
    columnDefs: [{
        ...
        orderable: !1,
        render: function (a, e, t, s) {
            return '<a href="/incident-reports/' + t.post_incident_id + '">' + t.post_incident_id + "</a>";
        }
    },
    {
    ...
    },
    {
        ...
        orderable: false,
        render: function (a, e, t, s) {
            return '<div class="d-flex align-items-center"><a href="/post-incident/' + t.post_incident_id + '" data-bs-toggle="tooltip" class="btn btn-icon" data-bs-placement="top" title="Preview Invoice"><i class="bx bx-show bx-md"></i></a></div>';
        }
    }],
    order: [[2, "desc"]],
    language: {
