$(function() {
  ...
  s.length && s.flatpickr({
      ...
      onClose: function(t, a, e) {
          var l;
          new Date;
          null != t[0] && (l = moment(t[0]).format("MM/DD/YYYY"),
          d.val(l)),
          null != t[1] && (l = moment(t[1]).format("MM/DD/YYYY"),
          c.val(l)),
  ...
  a.length && ($(".dt-column-search thead tr").clone(!0).appendTo(".dt-column-search thead"),
