...
@section('title', 'MUTI Group | Completed Reports')
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <!-- Invoice List Table -->
                        <div class="card">
                            <h5 class="card-header pb-0 text-md-start text-center">Completed Reports</h5>
...
@section('page_js')
    <script src="{{ asset('assets/js/completed-reports-list.js') }}"></script>
@endsection
