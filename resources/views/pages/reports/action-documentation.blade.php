...
@section('title', 'MUTI Group | Action Documentation Reports')
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <!-- Invoice List Table -->
                        <div class="card">
                            <h5 class="card-header pb-0 text-md-start text-center">Action Documentation Reports</h5>
...
@section('page_js')
    <script src="{{ asset('assets/js/action-documentation-list.js') }}"></script>
@endsection
